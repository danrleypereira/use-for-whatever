    ...
    <header className="kds-header">
      <Link to="/" className="kds-header-brand-link text-decoration-none">
        <div className="kds-header-brand">
          <img src="/img/KBRA-icon.png" alt="KBRA" />
          ...
          >
            <div className="header-nav-dropdown">
              ...
              <div className="header-nav-dropdown-content">
                <Link to="/deal-admin/annex-management/all">Annex Management</Link>
                <Link to="/deal-admin/exception_rules">Exception Preferences</Link>
      ...
      <div className="kds-header-utilities">
        ...
        >
          ...
          >
            <path
              d="M12 0a12 12 0 1012 12A12 12 0 0012 0zM6.21 20.15a7.6 7.6 0 015.79-3 7.58 7.58 0 015.78 3 10 10 0 01-11.57 0zm13.17-1.4l-.09.09A9.5 9.5 0 0012 15.17a9.51 9.51 0 00-7.29 3.66l-.09-.08a10 10 0 1114.76 0z"
            ></path>
            <path
              d="M12 4.15a5.29 5.29 0 105.28 5.3A5.3 5.3 0 0012 4.15zm0 8.57a3.29 3.29 0 113.28-3.3 3.3 3.3 0 01-3.28 3.3z"
            ></path>
          </svg>
          User
        </button>
